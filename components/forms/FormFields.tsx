    ...
    >
      {status === 'success' ? (
        <>
          ...
          <div>
            <p className="font-semibold text-foreground">{title ?? 'Message sent successfully.'}</p>
            <p className="mt-0.5 text-muted-foreground">{message ?? 'Our team will get back to you within a few business hours.'}</p>
          </div>
        </>
      ) : (
        <>
          ...
          <div>
            <p className="font-semibold text-foreground">{title ?? 'Something went wrong.'}</p>
            <p className="mt-0.5 text-muted-foreground">{message ?? 'Please try again, or call us directly.'}</p>
          </div>
        </>
      )}
    </div>
