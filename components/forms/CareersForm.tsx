...
export function CareersForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
      ...
      />
      <TextAreaField label="Why are you a great fit?" required error={errors.message?.message} {...register('message')} placeholder="Tell us about your experience and why Tri Fleet..." />
      <CheckboxField
        id="careers-consent"
