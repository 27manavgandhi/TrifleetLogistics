    ...
    <section className="section-py relative overflow-hidden">
      ...
      <div className="container-px relative mx-auto max-w-8xl">
        <SectionHeading
          ...
          highlight="GPS telematics, control-tower software and certified safety and quality systems underpin every Tri Fleet movement."
        />
          ...
          <div className="flex flex-col gap-6">
            <Reveal>
              <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-border shadow-card">
                <Image src={images.controlRoom4} alt="Tri Fleet 24/7 control room with monitoring screens" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
