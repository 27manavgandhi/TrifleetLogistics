...
const secondaryStats: Stat[] = [
  ...
  { icon: Award, value: 6, suffix: '', label: 'Industry certifications', sublabel: 'ISO, safety & quality standards' },
        ...
        <div className="mt-14 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/5 lg:grid-cols-4">
          {primaryStats.map((s, i) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center gap-2 p-7 text-center sm:p-10"
            >
