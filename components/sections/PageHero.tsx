  ...
  return (
    <section className="relative overflow-hidden bg-primary-deep pb-20 pt-32 text-primary-foreground sm:pt-40 lg:pb-28">
      ...
      <div className="container-px relative mx-auto max-w-8xl">
        <Reveal>
          <Breadcrumb items={breadcrumbs} className="[&_a]:text-white/60 [&_span]:text-white/80 [&_.text-muted-foreground]:text-white/40" />
        </Reveal>
        ...
        {align === 'split' ? (
          ...
          <div className={cn('mx-auto mt-10 flex max-w-3xl flex-col items-center text-center', align === 'center' && 'items-center')}>
            <Reveal>
