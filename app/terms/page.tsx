...
export const metadata: Metadata = constructMetadata({
  ...
  description: 'The terms and conditions governing the use of TriFleet Logistics services and website.',
  path: '/terms',
});

const sections = [
  { h: 'Acceptance of terms', p: 'By accessing the TriFleet Logistics website and engaging our services, you agree to these terms and conditions. If you do not agree, please do not use our website or services.' },
  { h: 'Services', p: 'TriFleet Logistics provides full truck load, part truck load, industrial transportation, door-to-door logistics and related transport services across India. Specific service terms, including pricing, transit times and SLAs, are agreed in writing at the time of engagement.' },
  ...
  { h: 'Liability and insurance', p: 'TriFleet takes reasonable care in transporting your freight. Our liability for loss or damage is limited in accordance with the terms agreed at engagement. We recommend transit insurance for high-value cargo and can assist in arranging coverage.' },
    ...
    <>
      <section className="relative overflow-hidden bg-primary-deep pb-16 pt-32 text-primary-foreground sm:pt-40">
        ...
        <div className="container-px relative mx-auto max-w-4xl">
          <Reveal><Breadcrumb items={[{ name: 'Terms & Conditions', path: '/terms' }]} className="[&_a]:text-white/60 [&_span]:text-white/80 [&_.text-muted-foreground]:text-white/40 [&_svg]:text-white/40" /></Reveal>
