...
export const metadata = constructMetadata({
  ...
  description: 'The page you are looking for could not be found. Explore TriFleet Logistics services instead.',
  path: '/404',
});
        ...
        <Reveal delay={0.35}>
          <div className="mt-6 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {popular.map((s) => (
                <Link key={s.slug} href="/services" className="group inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-medium text-white/70 transition-all hover:border-accent hover:text-accent-bright">
