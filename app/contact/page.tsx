...
export const metadata: Metadata = constructMetadata({
  title: 'Contact TriFleet Logistics — Get a Quote',
  description:
    'Contact TriFleet Logistics at C-5 Industrial Area, Phase 2, Mangolpuri, Delhi – 110034. Call +91 9211467575, email trifleetlogistics@gmail.com or WhatsApp +91 78276 00368.',
  path: '/contact',
});

const contactFaqs = [
  { q: 'How quickly will you respond to my enquiry?', a: 'Our team typically responds to enquiries within a few business hours. For urgent freight, call us directly on +91 9211467575 for an immediate response.' },
  ...
  { q: 'Can I get support for active shipments?', a: 'Yes. For active shipments, you can reach your account manager directly by phone or WhatsApp for updates and support.' },
];
      ...
      <section className="relative -mt-10 z-10">
        <div className="container-px mx-auto max-w-8xl">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: Phone, label: 'Call us', value: siteConfig.contact.phones[0], sub: 'Primary line', href: `tel:${siteConfig.contact.phoneE164[0]}` },
              { icon: Phone, label: 'Call us', value: siteConfig.contact.phones[1], sub: 'Alternate line', href: `tel:${siteConfig.contact.phoneE164[1]}` },
            ...
            <div className="flex flex-col gap-6">
              ...
              <Reveal variants={{ hidden: { opacity: 0, scale: 0.97 }, visible: { opacity: 1, scale: 1, transition: { duration: 0.7, ease: [0.16, 1, 0.3, 1] } } }}>
                <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-border shadow-card">
                  <iframe
                    title="TriFleet Logistics office location on Google Maps"
                    src={mapSrc}
