...
export const metadata: Metadata = constructMetadata({
  ...
  description: 'How Tri Fleet Logistics collects, uses and protects your personal information.',
  path: '/privacy',
});
    ...
    <>
      <section className="relative overflow-hidden bg-primary-deep pb-16 pt-32 text-primary-foreground sm:pt-40">
        ...
        <div className="container-px relative mx-auto max-w-4xl">
          <Reveal><Breadcrumb items={[{ name: 'Privacy Policy', path: '/privacy' }]} className="[&_a]:text-white/60 [&_span]:text-white/80 [&_.text-muted-foreground]:text-white/40" /></Reveal>
