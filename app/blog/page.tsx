...
export const metadata: Metadata = constructMetadata({
  title: 'Logistics Blog & Insights — Tri Fleet Logistics',
  description:
    'Logistics strategy, compliance, fleet management, cold chain, technology and cost optimisation insights from Tri Fleet Logistics. Read the latest articles on Indian transport.',
  path: '/blog',
});
