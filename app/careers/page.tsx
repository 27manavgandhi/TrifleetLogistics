...
export const metadata: Metadata = constructMetadata({
  title: 'Careers — Drive Your Career at TriFleet Logistics',
  description:
    'Join TriFleet Logistics. Open roles in operations, sales, fleet and driving. Work for a company that values safety, training and respect for its people.',
  path: '/careers',
});
...
export default function CareersPage() {
  return (
    <>
      ...
      <PageHero
        eyebrow="Careers"
        title="Drive your career at TriFleet"
      ...
      <section className="section-py relative">
        <div className="container-px mx-auto max-w-8xl">
          <SectionHeading eyebrow="Open Positions" title="Find your role" highlight="From dispatch to the cab — every role at TriFleet matters." />
      ...
      <section id="apply" className="section-py relative bg-secondary/40 scroll-mt-24">
      ...
      <CtaSection title="Don't see your role?" highlight="We're always looking for great people. Send your CV and a note about how you'd add to TriFleet." primaryLabel="Send Your CV" />
    </>
  );
}
