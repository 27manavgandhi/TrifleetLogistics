...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    'Tri Fleet Logistics case studies: how we improved on-time delivery for FMCG, built cold chain for pharma, eliminated line-stoppages for automotive and scaled e-commerce line-haul.',
  path: '/case-studies',
});
  ...
  return (
    <>
      ...
      <PageHero
        ...
        highlight="How Tri Fleet turned logistics challenges into measurable results for clients across FMCG, pharma, automotive, e-commerce and more."
