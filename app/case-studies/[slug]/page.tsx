    ...
    <>
      ...
      <section className="relative overflow-hidden bg-primary-deep pb-16 pt-32 text-primary-foreground sm:pt-40">
        ...
        <div className="container-px relative mx-auto max-w-5xl">
          <Reveal>
            <Breadcrumb items={[{ name: 'Case Studies', path: '/case-studies' }, { name: cs.title, path: `/case-studies/${cs.slug}` }]} className="[&_a]:text-white/60 [&_span]:text-white/80 [&_.text-muted-foreground]:text-white/40 [&_svg]:text-white/40" />
          </Reveal>
