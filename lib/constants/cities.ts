...
export const cities: City[] = [
  {
    ...
    intro: [
      'Delhi is where Tri Fleet Logistics was founded and where our central control room operates 24/7. From our Mangolpuri hub in North-West Delhi, we coordinate full truck load, part truck load and dedicated fleet movements across the National Capital Region and the entire country.',
    ...
    whyLocal: [
      ...
      '24/7 control room coordinating pan-India movements',
    ...
    testimonial: { quote: 'Tri Fleet picks up from our Mangolpuri unit within hours of a booking and keeps our North-India distribution moving without a single delay.', author: 'Rajesh Verma', role: 'Supply Chain Manager', company: 'Delhi-based FMCG distributor' },
  ...
  },
  {
    ...
    intro: [
      'Noida is one of the fastest-growing industrial and manufacturing corridors in North India, and Tri Fleet Logistics moves freight for businesses across Sector 1 to Sector 168 — from electronics manufacturers in the NSEZ to apparel exporters and automotive components suppliers.',
      'Being just across the border from Delhi, Noida benefits from our Mangolpuri hub\'s proximity. We pick up and deliver across Noida with the same 24/7 control and GPS visibility that defines our national operations.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'From our Noida factory to customers across India, Tri Fleet delivers on time, every time. Their control room is always reachable.', author: 'Anita Sharma', role: 'Operations Head', company: 'Noida electronics manufacturer' },
  ...
  },
  {
    ...
    intro: [
      'Gurgaon (Gurugram) is the corporate and warehousing powerhouse of the NCR, home to multinational offices, e-commerce fulfilment centres and industrial clusters in Manesar and Udyog Vihar. Tri Fleet Logistics serves businesses across the city with full truck load, part load and dedicated fleet solutions.',
      'Our proximity to Gurgaon means we can mobilise vehicles quickly for the city\'s e-commerce peaks, retail distribution cycles and manufacturing runs — all backed by the same 24/7 control and GPS visibility.',
    ],
    whyLocal: [
  ...
  },
  {
    ...
    intro: [
      'Faridabad is one of the NCR\'s oldest and largest industrial clusters, specialising in heavy engineering, auto-components, footwear and consumer goods. Tri Fleet Logistics moves freight for manufacturers across the city\'s industrial sectors with vehicles suited to heavy and oversized loads.',
      'Our crews are experienced with Faridabad\'s industrial cargo profile, and our control room keeps every shipment visible from pickup at the factory gate to delivery at destination.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'Moving our heavy machinery out of Faridabad used to be a headache. Tri Fleet handles the permits, escorts and delivery seamlessly.', author: 'Suresh Kumar', role: 'Plant Manager', company: 'Faridabad engineering firm' },
  ...
  },
  {
    ...
    intro: [
      'Ghaziabad is a major industrial and logistics hub on the eastern edge of Delhi, home to packaging, FMCG, steel and electronics manufacturers across Sahibabad, Mohan Nagar and the Loni industrial belt. Tri Fleet Logistics serves businesses across the city with reliable full truck load and dedicated fleet operations.',
      'Our crews know Ghaziabad\'s industrial corridors and traffic patterns, and our 24/7 control room ensures every shipment stays on schedule from pickup to proof of delivery.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'Tri Fleet moves our packaging material from Ghaziabad to plants across North India without a single hiccup. Reliable and professional.', author: 'Mohammed Iqbal', role: 'Procurement Lead', company: 'Ghaziabad packaging manufacturer' },
  ...
  },
  {
    ...
    intro: [
      'Sonipat, on the northern edge of Delhi NCR, is emerging as a major industrial and logistics corridor with the Kundli Industrial Area and the developing Kundli–Narela multi-modal hub. Tri Fleet Logistics serves Sonipat\'s manufacturers and warehousing operators with full truck load and part load services.',
      'Our proximity to Sonipat means fast pickups, direct highway access via NH-44 and the same 24/7 GPS-tracked visibility on every shipment.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'From our Kundli unit, Tri Fleet gets our freight moving faster than anyone we\'ve worked with before.', author: 'Deepak Goyal', role: 'Director', company: 'Sonipat apparel exporter' },
  ...
  },
  {
    ...
    intro: [
      'Bahadurgarh, the "Gateway to Haryana", is a fast-growing industrial hub with HSIIDC industrial estates and a strong manufacturing base in footwear, steel and packaging. Tri Fleet Logistics serves Bahadurgarh businesses with full truck load and dedicated fleet solutions backed by 24/7 control.',
    ...
    testimonial: { quote: 'Tri Fleet understands Bahadurgarh\'s industrial rhythm. Their pickups are always on time and their crew is professional.', author: 'Ramesh Tyagi', role: 'Owner', company: 'Bahadurgarh footwear manufacturer' },
  ...
  },
  {
    ...
    intro: [
      'Panipat is globally known as the "City of Weavers" and is a powerhouse of textiles, handloom, blankets and home furnishings — alongside a major refinery and industrial cluster. Tri Fleet Logistics moves textile and industrial freight from Panipat to destinations across India and to ports for export.',
      'Our crews understand the nuances of textile cargo — bale handling, moisture protection and secure loading — and our control room keeps every shipment visible end to end.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'Our blankets ship from Panipat to all of India and to Mundra for export. Tri Fleet handles it all with care and on time.', author: 'Inderjeet Singh', role: 'Partner', company: 'Panipat textile exporter' },
  ...
  },
  {
    ...
    intro: [
      'Rohtak is a major urban and industrial centre in Haryana, home to HSIIDC industrial model townships, agri-processing units and a growing manufacturing base. Tri Fleet Logistics serves Rohtak businesses with full truck load, part load and industrial transportation services.',
      'Our proximity to Rohtak via NH-352 and NH-709 means fast dispatch and reliable transit, all monitored by our 24/7 control room.',
    ],
    whyLocal: [
    ...
    testimonial: { quote: 'Reliable, professional and always on time. Tri Fleet manages our Rohtak factory\'s outbound freight flawlessly.', author: 'Naresh Malhotra', role: 'Director', company: 'Rohtak agri-processing firm' },
