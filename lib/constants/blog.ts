...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'Inside the TriFleet 24/7 control room',
    ...
    content: [
      'The control room is the heart of TriFleet Logistics. It is where every vehicle is monitored, every exception is caught and every delivery is kept on schedule. Here is how it works.',
...
export const careers: Career[] = [
  {
    ...
    type: 'Full-time',
    excerpt: 'Join our 24/7 control room and keep every TriFleet vehicle visible, on schedule and exception-free.',
    responsibilities: [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Represent TriFleet professionally with clients',
    ],
    requirements: [
  ...
  },
  {
    ...
    location: 'Delhi (On-site)',
    type: 'Full-time',
    excerpt: 'Keep our 350+ vehicle fleet roadworthy, reliable and compliant through preventive maintenance.',
    responsibilities: [
